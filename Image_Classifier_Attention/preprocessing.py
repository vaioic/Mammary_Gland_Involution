...
class WSIPreprocessor:
    ...
    def process_single_slide(
        ...
        h5_path = slide_output_dir / f"{slide_id}_patches.h5"
    ...
    def process_dataset(
        ...
        Args:
            metadata_df: DataFrame with columns ['slide_id', 'label', ...]
        ...
        for _, row in metadata_df.iterrows():
            ...
            mask_path = mask_dir / f"{slide_id}_mask.png"  # Adjust extension as needed
        ...
        output_df = metadata_df.merge(results_df, on='slide_id', how='left')
