...
class WSIDataset(Dataset):
    ...
    def __init__(
        ...
        """
        Args:
            metadata_df: DataFrame with columns ['Image', 'label', 'h5_path', ...]
...
def create_dataloaders(
    ...
    Args:
        train_df: training data pandas df generated by sklearn train_test_split
        val_df: validation data pandas df generated by sklearn train_test_split
        test_df: test data pandas df generated by sklearn train_test_split (optional)
